...
public class Utils {
    ...
    public boolean addToAlreadyRead(BookModel book){
        return alreadyReadBooks.add(book);
    }

    public boolean addToReadList(BookModel book){
        return readList.add(book);
    }

    public boolean addToFavorite(BookModel incomingBook) {
